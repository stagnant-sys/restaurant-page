...
MEALS_TAB_BUTTON.addEventListener('click', () => {
  ...
  (0,_meals_page__WEBPACK_IMPORTED_MODULE_4__.createMeal)('Gyoza', 'Our finest steamed dumpling filled with a minced pork stuffing.', 4, image_path + 'dumpling.png');
  (0,_meals_page__WEBPACK_IMPORTED_MODULE_4__.createMeal)('Maki', 'Juicy rice rolled in seaweed, complete with your choice of filling (crab, tuna, salmon, vegetables).', 5, image_path + 'maki.png');
  (0,_meals_page__WEBPACK_IMPORTED_MODULE_4__.createMeal)('Egg Nigiri', 'A delicious nigiri topped with a slice of omelette.', 3, image_path + 'nigiri-egg.png');
  (0,_meals_page__WEBPACK_IMPORTED_MODULE_4__.createMeal)('Salmon Nigiri', 'An exquisite nigiri topped with salmon sashimi.', 4, image_path + 'nigiri-salmon.png');
  (0,_meals_page__WEBPACK_IMPORTED_MODULE_4__.createMeal)('Squid Nigiri', 'A luscious nigiri topped with fresh squid.', 3, image_path + 'nigiri-squid.png');
  (0,_meals_page__WEBPACK_IMPORTED_MODULE_4__.createMeal)('Sashimi', 'A yummy selection of our best sashimis (bonito, salmon, bluefin tuna).', 9, image_path +'sashimi.png');
  (0,_meals_page__WEBPACK_IMPORTED_MODULE_4__.createMeal)('Shrimp tempura', 'Lightly battered and deep fried shrimps.', 7, image_path + 'tempura.png');
  (0,_meals_page__WEBPACK_IMPORTED_MODULE_4__.createMeal)('Wasabi', 'Get your tongue lit up with our authentic wasabi paste, ready to accompany any of our meals.', 1, image_path + 'wasabi.png');
  (0,_meals_page__WEBPACK_IMPORTED_MODULE_4__.createMeal)('Pudding', 'End your meal on a sweet note with our delicious pudding.', 5, image_path + 'pudding.png');
});
